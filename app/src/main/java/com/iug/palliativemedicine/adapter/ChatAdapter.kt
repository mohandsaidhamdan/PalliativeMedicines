...
class ChatAdapter(private val context: Context, private val chatList: ArrayList<ChatMessage>) :
    ...
    val sender  = context.getSharedPreferences("user", AppCompatActivity.MODE_PRIVATE).getString("email", "").toString()
    override fun getItemViewType(position: Int): Int {
        firebaseUser = FirebaseAuth.getInstance().currentUser
        if (chatList[position].senderId == sender) {
